    ...
    return (
        <div className="landing-page-content">
            <div className="landing-page-intro-section">
                <h1>The Basketball Platform - Where pick-up becomes planned</h1>
            ...
            <div className="landing-page-all-cards-container">
                <LandingPageCard imageUrl={highFive} alt="An image of a high five" path={'/groups'} cardTitle='See all Groups' cardText='Look at all the basketball groups registered on Ballr!' />
                <LandingPageCard imageUrl={bballCourt} alt="An image of a basketball court" path={'/events'} cardTitle='Find an event' cardText='Search for basketball events registered on Ballr!' />
                <LandingPageCard imageUrl={basketballPlayers} alt="An image of two basketball players" path={'/groups/new'} cardTitle='Start a new group' cardText='Register a new group on Ballr!' />
            </div>
